...
function test_avm__send_nft_2a {
    check "$(AVAX_ID_RPC=1 $(cmd) \
        -a ASSET_ID -@ TO -f A1 -f A2 -c A3 -u USERNAME -p PASSWORD -b BC_ID \
        )" BC_ID ;
}
